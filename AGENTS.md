...
The latest integrated production/audit baseline after PR #51 is:

- `main` `1d6c2c04571fbdf124bc2530e92c390808b5345f` (merge commit for PR #51)
- PR #51 required checks: GREEN (`test`, `browser-selection-audit`, `browser-interaction-audit`, `browser-chronology-audit`, and `browser-publication-order-audit`; the first chronology attempt timed out at the hosted 180-second limit and the failed job rerun passed)
- 443 / 443 library-v5 unit tests PASS locally (4 browser tests are environment-gated skips in the ordinary suite)
...
- work relations: 164 rows (18 `source_verified`, 143 `legacy_seed`, 3 `superseded`)
- sources: 55
- evidence: 145
- reviews: 119
- `work_edges_all`: 355
